...
printf '%s\n' '0 3 * * * /opt/irish-rail-tracker/scripts/nightly-backup.sh # irish-rail-tracker-backup' >> "$cron_dir/new"
crontab "$cron_dir/new"
echo "[cron] Backup scheduled at 03:00 in the server timezone; log: /opt/irish-rail-tracker/backup.log (rotated at 1 MiB)"
